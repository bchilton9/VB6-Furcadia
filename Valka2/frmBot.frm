...
sckFurc.SendData "m 7" & vbLf & "m 3" & vbLf
...
sckFurc.SendData "use" & vbLf & "m 3" & vbLf
End If
...
End If
        ...
        'watch for data 7 = 3 = 4 J = 4     7 ? 7 > 6 F > 6
            ...
            'End If
        If Txt = ") + 6" Then sckFurc.SendData "l  ) 1" & vbLf
        If Txt = ") * 8" Then sckFurc.SendData "l  ( 3" & vbLf
...
If armo = 8 Then armo = "Plate Mail"
        sckFurc.SendData Chr(34) & "emit " & Furre & " The " & clas & " of level " & lvl & " Welding " & weap & " and " & armo & " has entered the fighting area." & vbLf
            Open "fnum.txt" For Input As #1
            Input #1, fnum
            Close #1
            If fnum = 2 Then
...
whspnum = 2
ElseIf Msg Like "join fight" Then
whspnum = 3
...
whspnum = 11
ElseIf Msg Like "how to fight" Then
whspnum = 12
ElseIf Msg Like "bar" Then
whspnum = 13
ElseIf Msg Like "menu" Then
whspnum = 14
...
If whspnum = 1 Then sckFurc.SendData "wh " & Furre & " To learn how I work whisper me a command. My commands are JOIN, FIGHTING, STATS, BUY." & vbLf
...
If whspnum = 20 Then
    cmdrest_Click
    sckFurc.SendData "wh " & Furre & " Arena Closed" & vbLf & "m 7" & vbLf & Chr(34) & "emit This arena is closed!" & vbLf
End If
If whspnum = 21 Then
    cmdrest_Click
    sckFurc.SendData Chr(34) & "emitloud This arena was reset by " & Furre & "!" & vbLf
End If
End Sub
...
If turn = 1 Then
    ...
    Else
       nhp = thp - hit
       sckFurc.SendData Chr(34) & "emit " & fnam & " " & atk & " " & tfnam & " For " & hit & " Points of damage, leaveing them with " & nhp & " hitpoint's remaining." & vbLf
       Open "fighter2.txt" For Output As #1
...
sckFurc.SendData Chr(34) & "emitloud " & win & " has defeted " & lose & vbLf
Open "fnum.txt" For Output As #1
Write #1, 0
Close #1
Open "fighter1.txt" For Output As #1
