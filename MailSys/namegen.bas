...
l0086 = Int(33 * Rnd + 1)
l008A = Int(72 * Rnd + 1)
frmBot.usrname.Text = l0070(l0082) + l0076(l0086) + l007C(l008A)
End Sub
...
frmBot.usrname.Text = l008E(l00A0) + l0094(l00A4) + l009A(l00A8)
End Sub
...
frmBot.usrname.Text = l00AC(l00BE) + l00B2(l00C2) + l00B8(l00C6)
   End Sub
    Sub elf()
    On Error Resume Next
Dim l00CA() As String
...
frmBot.usrname.Text = l00CA(l00DC) + l00D0(l00E0) + l00D6(l00E4)
 End Sub
 Sub felana()
 On Error Resume Next
Dim l00E8() As String
...
frmBot.usrname.Text = l00E8(l00FA) + l00EE(l00FE) + l00F4(l0102)
    End Sub
    Sub galler()
On Error Resume Next
Dim l0106() As String
...
frmBot.usrname.Text = l0106(l0118) + l010C(l011C) + l0112(l0120)
    End Sub
...
frmBot.usrname.Text = l012A(l0148) + l0136(l014C) + l0142(l0150)
End Sub
